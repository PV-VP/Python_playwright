...
def test_create_task(page:Page, open_odoo):
    ...
    # ПЕРШИЙ dropdown - філія витрати
    page.locator("#crnd_widget_vr_name_affiliate_id").click()
    page.wait_for_timeout(800)
    page.locator("#crnd_widget_vr_name_affiliate_id").get_by_text("Новокостянтинівська", exact=True).click()
    # ТРЕТІЙ dropdown - філія видачи готівки
    page.locator("#crnd_widget_vr_cash_withdrawal_affiliate_id").click()
    page.wait_for_timeout(800)
